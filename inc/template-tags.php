...
function twentyfourteen_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<div class="nav-links">
			<div class="row">
				<div class="col-md-6"><?php previous_post_link('%link', '%title'); ?></div>
				<div class="col-md-6"><div class="pull-right"><?php next_post_link('%link', '%title') ?></div></div>
			</div><!-- .row -->
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
 ...
 * @return void
*/
function twentyfourteen_post_thumbnail($size = 'lair-default') {
